...
import 'package:qr_code_app/GoogleSheet/QrFormWidget.dart';
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(
                     ...
                     Container(
                        child: Qrformwidget(
                          onSavedCode: (QR) async {
                            final id = await UserSheetApi.getRowID() + 1;
                
                            final newCode = QR.copy(id: id);
                            await UserSheetApi.insert([newCode.toJson()]);
                          },
                        ),
                      )
                  ],
